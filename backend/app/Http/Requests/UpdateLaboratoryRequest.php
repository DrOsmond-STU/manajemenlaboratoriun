...
class UpdateLaboratoryRequest extends FormRequest
{
    ...
    {
        return [
            'kode' => ['sometimes', 'string', 'max:32',
                Rule::unique('laboratories', 'kode')->ignore($this->route('laboratory')?->id)->withoutTrashed()],
            ...
            'status' => ['sometimes', Rule::in(array_keys(Laboratory::STATUS))],
